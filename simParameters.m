...
switch caseno
    ...
    case 635    % case 28 with 4.5 seconds cruising
        mpod = 411.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
...
%         deltax_pusher = 312;     % Desired max push distance (max: 487.68m or 1600ft) (m)
        ...
        vpod_max = 4.0;            % Constraint on max velocity (m/s)
        deltat_jerk = 0.0;          % jerk time for pusher to ramp to full acceleration (s)
        deltat_pusher = 1.5;     % Desired max push distance (max: 487.68m or 1600ft) (m)
...
%         gForce_brakedrag = 1.0;     % Constraint on max braking force (g's)
        brakegapNom = 8;          % Nominal brake gap during controlled braking phase (mm)
        deltax_dangerzone = 7;     % Distance between final target and end of track (DANGER ZONE!!!) (m)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 634    % case 28 with 4.5 seconds cruising
        mpod = 411.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 37;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
...
%         deltax_pusher = 312;     % Desired max push distance (max: 487.68m or 1600ft) (m)
        deltax_pusher_max = 487.68; % Max push distance (max: 487.68m or 1600ft) (m)
        vpod_max = 2.0;            % Constraint on max velocity (m/s)
        deltat_jerk = 0.0;          % jerk time for pusher to ramp to full acceleration (s)
        deltat_pusher = 1.5;     % Desired max push distance (max: 487.68m or 1600ft) (m)
        deltat_cruising = 1;        % Cruising time between pusher and deceleration phase (minimum 2s required) (s)
%         gForce_brakedrag = 1.0;     % Constraint on max braking force (g's)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 632    % case 28 with 4.5 seconds cruising
...
%         vpod_max = 90.;            % Constraint on max velocity (m/s)
        ...
        deltat_pusher = 6;     % Desired max push distance (max: 487.68m or 1600ft) (m)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 631	% used to test hover & ski option switch
        mpod = 441.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 1250;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 549	% low pressure case at 1.0g with skis (Updated brake actuator dynamics)
        mpod = 441.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 1250;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
...
%         vpod_max = 90.;            % Constraint on max velocity (m/s)
        deltat_pusher = 10;     % Desired max push distance (max: 487.68m or 1600ft) (m)
        deltat_cruising = 4.0;        % Cruising time between pusher and deceleration phase (minimum 2s required) (s)
%         gForce_brakedrag = 1.0;     % Constraint on max braking force (g's)
        brakegapNom = 5;          % Nominal brake gap during controlled braking phase (mm)
        deltax_dangerzone = 50;     % Distance between final target and end of track (DANGER ZONE!!!) (m)
        z_nom = 0.012;              % Nominal hover height (m) based on pod mass and 8 hover engines
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 065	% low pressure case at 1.0g with skis (Updated brake actuator dynamics)
        mpod = 441.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 1250;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 064	% low pressure case at 1.0g with skis (Updated brake actuator dynamics)
        mpod = 441.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 1250;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 063	% low pressure case at 1.0g with skis (Updated brake actuator dynamics)
        mpod = 441.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 1250;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
...
%         rho = 1.2754;               % Standard Air density at 20 degC, sealevel(kg/m^3)
    ...
    case 062	% (Decommissioned) low pressure case at 4.0g with skis (for tuning gain scheduled PID)
        mpod = 441.;                % Total pod mass (kg)
        dt = 0.01;                 % time step (s)
        xf = 2500;                  % Target distance (m)
        xdotf = 0.01;               % Target final velocity at xf (m/s)
        gForce_pusher_max = 4.0;        % Pusher acceleration (g's)
%         deltax_pusher = 312;     % Desired max push distance (max: 487.68m or 1600ft) (m)
        deltat_jerk = 0.3;          % jerk time for pusher to ramp to full acceleration (s)
        deltax_pusher_max = 487.68; % Max push distance (max: 487.68m or 1600ft) (m)
%         vpod_max = 90.;            % Constraint on max velocity (m/s)
        deltat_pusher = 30;     % Desired max push distance (max: 487.68m or 1600ft) (m)
        deltat_cruising = 2;        % Cruising time between pusher and deceleration phase (minimum 2s required) (s)
%         gForce_brakedrag = 1.0;     % Constraint on max braking force (g's)
        brakegapNom = 7;          % Nominal brake gap during controlled braking phase (mm)
        deltax_dangerzone = 8;     % Distance between final target and end of track (DANGER ZONE!!!) (m)
        z_nom = 0.012;              % Nominal hover height (m) based on pod mass and 8 hover engines
        ski_option = true;          % Enables/disables addition of skis
        instant_braking = false;     % true = brakes reach nominal brakegap instantaneously
